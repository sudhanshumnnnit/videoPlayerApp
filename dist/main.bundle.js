...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__videoservice_video_service__ = __webpack_require__("../../../../../src/app/videoservice/video.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__safe_pipe_safe_pipe__ = __webpack_require__("../../../../../src/app/safe-pipe/safe.pipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__global_service_global_service__ = __webpack_require__("../../../../../src/app/global-service/global.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__safe_pipe_safe_pipe__["a" /* SafePipe */]
            ],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_10__videoservice_video_service__["a" /* VideoService */], __WEBPACK_IMPORTED_MODULE_12__global_service_global_service__["a" /* GlobalService */]],
...
/***/ "../../../../../src/app/global-service/global.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "../../../../../src/app/safe-pipe/safe.pipe.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
module.exports = "<!-- <p>\n  video-center works!\n</p> -->\n<div class=\"row\">\n  <div class=\"col-sm-9\">\n    <div *ngIf=\"!hideNewVideo\">\n      <h2>New Video</h2>\n      <form action=\"\" #form=\"ngForm\" class=\"well\" (ngSubmit)=\"onSubmitAddVideo(form.value)\">\n        <div class=\"form-group\">\n          <label for=\"\">Title</label>\n          <input type=\"text\" class=\"form-control\" required name=\"title\" ngModel>\n        </div>\n        <div class=\"form-group\">\n            <label for=\"\">Url</label>\n            <input type=\"text\" class=\"form-control\" required name=\"url\" ngModel>\n        </div>\n        <div class=\"form-group\">\n            <label for=\"\">Description</label>\n            <input type=\"text\" class=\"form-control\" required name=\"desc\" ngModel>\n        </div>\n        <button type=\"submit\" class=\"btn btn-success\" >Save</button>\n      </form>\n    </div>\n    <app-video-detail *ngIf=\"selVideo && hideNewVideo\" [onlyVideo]=\"selVideo\"></app-video-detail> \n  </div>\n  <div class=\"col-sm-3\">\n    <button style='margin-bottom:2px' type='button' class=\"btn btn-success btn-block\" (click)=\"newVideoButtonClick()\">+New Video</button>\n    <app-video-list (SelectVideoEvent)=\"onSelectVideo($event)\" [videos1]='videos'></app-video-list>\n  </div>\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__videoservice_video_service__ = __webpack_require__("../../../../../src/app/videoservice/video.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var VideoCenterComponent = (function () {
    ...
    VideoCenterComponent.prototype.newVideoButtonClick = function () {
    ...
    VideoCenterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__videoservice_video_service__["a" /* VideoService */]])
...
module.exports = "<div class=\"panel  panel-primary\">\n  <div class=\"panel-heading\">\n    <h3 class=\"panel-title\">Panel title</h3>\n  </div>\n  <div class=\"panel-body\">\n    Panel content\n    <div>\n      <iframe width=\"100%\" height=\"300\" [src]=\"onlyVideo.url | safe\"></iframe>\n    </div>\n    <!-- <div>{{onlyVideo.title}}</div>\n    <div>{{onlyVideo.url}}</div>\n    <div>{{onlyVideo.desc}}</div> -->\n\n    <form>\n      <div class=\"form-group\" *ngIf=\"editTitle\">\n        <input type=\"text\" class=\"form-control\" id=\"title\" name=\"title\" placeholder=\"Title\" required [(ngModel)]=\"onlyVideo.title\">\n      </div>\n      <h3 *ngIf=\"!editTitle\" (click)=onTitleClick()>{{onlyVideo.title}}</h3>\n      <div class=\"form-group\">\n        <input type=\"text\" class=\"form-control\" id=\"url\" name=\"url\" placeholder=\"URL\" [(ngModel)]=\"onlyVideo.url\" required>\n      </div>\n      <div class=\"form-group\">\n        <label for=\"exampleInputPassword1\">Password</label>\n        <textarea  class=\"form-control\" rows=\"5\" name=\"desc\"  id=\"DESC\" placeholder=\"DESC\" [(ngModel)]=\"onlyVideo.desc\" required></textarea>\n      </div>\n    </form>\n  </div>\n</div>"
...
module.exports = "<ul class='nav nav-pills nav-stacked'>\n  <li *ngFor='let video of videos1' (click)=\"onSelect(video)\"><a>{{video.title}}</a></li>\n\n</ul>\n"
...
var VideoListComponent = (function () {
    function VideoListComponent() {
        this.SelectVideoEvent = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* EventEmitter */]();
    }
...
/***/ "../../../../../src/app/videoservice/video.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__global_service_global_service__ = __webpack_require__("../../../../../src/app/global-service/global.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var VideoService = (function () {
    function VideoService(_http, _global) {
        this._http = _http;
    ...
    VideoService.prototype.addNewVideo = function (video) {
    ...
    VideoService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Http */], __WEBPACK_IMPORTED_MODULE_3__global_service_global_service__["a" /* GlobalService */]])
    ], VideoService);
    return VideoService;
}());
